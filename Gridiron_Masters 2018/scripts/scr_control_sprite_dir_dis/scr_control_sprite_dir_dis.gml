...
if dir >= 45 and dir <= 135 and sprite_index != s_player_tall_run_up {
	sprite_index = s_player_tall_run_up;
} else if dir >= 135 and dir <= 225 and sprite_index != s_player_tall_run_left {
	sprite_index = s_player_tall_run_left;
} else if dir >= 225 and dir <= 315 and sprite_index != s_player_tall_run_down {
	sprite_index = s_player_tall_run_down
} else if dir >= 315 or dir <= 45 and sprite_index != s_player_tall_run_right {
